...
package kafka.manager.utils.two30
...
private[two30] sealed trait GroupState
...
/**
  ...
  */
private[two30] case object PreparingRebalance extends GroupState
...
/**
  ...
  *             group is removed by partition emigration => Dead
  */
private[two30] case object CompletingRebalance extends GroupState
...
/**
  ...
  *             group is removed by partition emigration => Dead
  */
private[two30] case object Stable extends GroupState
...
/**
  ...
  */
private[two30] case object Dead extends GroupState
...
/**
  ...
  */
private[two30] case object Empty extends GroupState
...
class GroupMetadata(val groupId: String, initialState: GroupState, time: Time) extends Logging {
  ...
  private[two30] val lock = new ReentrantLock
  ...
  // visible for testing
  private[two30] def offsetWithRecordMetadata(topicPartition: TopicPartition): Option[CommitRecordMetadataAndOffset] = offsets.get(topicPartition)
